...
* [`src/re_frame_resume/styles.cljs`](src/re_frame_resume/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/re_frame_resume/`](src/re_frame_resume/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/re_frame_resume/core.cljs): contains the SPA entry point, `init`
* [`test/re_frame_resume/`](test/re_frame_resume/): test files (ClojureScript,
...
The `debug?` variable in [`config.cljs`](src/cljs/re_frame_resume/config.cljs) defaults to `true` in
